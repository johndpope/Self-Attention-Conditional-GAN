...
def calculate_kid_given_paths(paths, model_name, model_path, feature_path=None):
    ...
    with tf.Session() as sess:
        ...
        if feature_path is None:
            ...
            np.savez('features.npz', m =m2 , s = s2,features= features2) 
        else:
...
user_images_unzipped_path = args.fname+'/'
images_path = [user_images_unzipped_path,'all-dogs/']

public_path = 'dog-face-generation-competition-kid-metric-input/classify_image_graph_def.pb'

fid_epsilon = 10e-15

fid_value_public, distance_public = calculate_kid_given_paths(images_path, 'Inception', public_path,feature_path ='features.npz')
